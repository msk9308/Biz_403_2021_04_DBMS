...
-- 		접근이 된다
-- MySQL : DataBase가 schema가 되고 alter
--  		  모든 데이터의 저장공간이 된다 
...
GRANT ALL privileges on *.* TO gbUser@127.0.0.1;

-- 현재 공유기에 공통으로 연결된 PC 에서 MySQL Server에 접근하라 
CREATE USER gbUser@'192.168.0.%';

-- 현재 공유기에 공통으로 연결된 PC에서 접근할 때 모든권한을 부여하겠다
